...
<template>
    <i-article>
        <article>
            ...
            <Demo title="默认配置 circle圆环" :vertical="true">
                <div slot="demo" style="text-align: center;background-color:#f75147;padding: 30px;">
                    <div class="line-bar">
                        <svg-bar type="rect" :value="90" :options="lineBarOptions" :valAddCalBack="valAddCalBack"
                                 class="svg-bar"></svg-bar>
                        <ul class="vip-sign">
